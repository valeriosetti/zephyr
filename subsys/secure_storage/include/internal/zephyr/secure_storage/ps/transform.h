...
/** @file zephyr/secure_storage/ps/transform.h The secure storage ITS transform module.
 *
 ...
 * ITS transform module (@kconfig{CONFIG_SECURE_STORAGE_PS_TRANSFORM_IMPLEMENTATION_CUSTOM}).
 */
