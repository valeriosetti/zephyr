...
/** @file zephyr/secure_storage/ps/store.h The secure storage ITS store module.
 *
 ...
 * ITS store module (@kconfig{CONFIG_SECURE_STORAGE_PS_STORE_IMPLEMENTATION_CUSTOM}).
 *
