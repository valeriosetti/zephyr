 ...
 */
#ifndef SECURE_STORAGE_PS_TRANSFORM_AEAD_H
#define SECURE_STORAGE_PS_TRANSFORM_AEAD_H

/** @file zephyr/secure_storage/ps/transform/aead.h The AEAD ITS transform module API.
 *
 ...
 * or more of these functions (@kconfig_regex{CONFIG_SECURE_STORAGE_PS_TRANSFORM_AEAD_.*_CUSTOM}).
 */
#include <zephyr/secure_storage/uid.h>
#include <psa/crypto_types.h>

/** @brief ITS transform AEAD tag size */
#define SECURE_STORAGE_PS_TRANSFORM_AEAD_TAG_SIZE                     \
...
psa_status_t secure_storage_ps_transform_aead_crypt(
		...
		const uint8_t nonce[static CONFIG_SECURE_STORAGE_PS_TRANSFORM_AEAD_NONCE_SIZE],
...
#if defined(CONFIG_SECURE_STORAGE_PS_TRANSFORM_AEAD_SCHEME_IS_CONFIGURABLE) || defined(__DOXYGEN__)
 ...
 */
void secure_storage_ps_transform_aead_get_scheme(psa_key_type_t *key_type, psa_algorithm_t *alg);

#endif /* CONFIG_SECURE_STORAGE_PS_TRANSFORM_AEAD_SCHEME_IS_CONFIGURABLE */

#if !defined(CONFIG_SECURE_STORAGE_PS_TRANSFORM_AEAD_CRYPT_CUSTOM) || defined(__DOXYGEN__)
...
#endif /* SECURE_STORAGE_PS_TRANSFORM_AEAD_CRYPT_CUSTOM */
